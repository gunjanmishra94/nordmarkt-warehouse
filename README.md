...
- **Dashboard:** [nordmarkt-warehouse.streamlit.app](https://nordmarkt-warehouse.streamlit.app/) — Streamlit Community Cloud, querying a MotherDuck database that `.github/workflows/motherduck.yml` keeps built and fresh (nightly, and on every push to `main`)
- **dbt docs:** [gunjanmishra94.github.io/nordmarkt-warehouse](https://gunjanmishra94.github.io/nordmarkt-warehouse/) — lineage graph and every column's description, built and published by `.github/workflows/demo.yml`

---

## Why this exists

Nordmarkt sells homeware across Germany, Austria and Switzerland: orders get shipped, cancelled, or refunded, customers move house or change tier, some pay in Swiss francs. The raw data is a mess, as raw data always is — events arrive late, orders duplicate, timestamps span three timezones, a column got renamed mid-history with no note left behind. This repo sits between that mess and questions like:
